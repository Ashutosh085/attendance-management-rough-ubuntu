    ...
    protected function getViewData(): array
{
    ...
    while ($currentDate <= $endOfMonth) {
        ...
        // In your MonthlyAttendanceWidget.php file
$calendar->push([
    'date' => $currentDate->copy(),
    'isWeekend' => $currentDate->isSaturday() || $currentDate->isSunday(),
    'isHoliday' => $holiday ? true : false,
    'holidayName' => $holiday ? $holiday->name : null,
    'holidayType' => $holiday ? $holiday->type : null, // Add this line to pass the holiday type
    ...
    private function getArrivalTime($attendances)
    {
        ...
        return $checkIns->isEmpty() ? 'N/A' : Carbon::parse($checkIns->min())->timezone('Asia/Kolkata')->format('h:i A');
    }
